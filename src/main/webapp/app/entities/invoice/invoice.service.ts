...
export class InvoiceService {
    ...
    private convertDateFromClient(invoice: IInvoice): IInvoice {
        const copy: IInvoice = Object.assign({}, invoice, {
            date: invoice.date != null && invoice.date.isValid() ? invoice.date.format(DATE_FORMAT) : null,
            paymentDate: invoice.paymentDate != null && invoice.paymentDate.isValid() ? invoice.paymentDate.format(DATE_FORMAT) : null
        });
        return copy;
    }
