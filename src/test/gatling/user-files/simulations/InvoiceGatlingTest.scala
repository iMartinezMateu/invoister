...
class InvoiceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Invoice entity")
        ...
        .repeat(2) {
            ...
            .post("/api/invoices")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "date":"2020-01-01T00:00:00.000Z", "tax":"0", "paymentForm":null, "paymentDetails":"SAMPLE_TEXT", "paymentDate":"2020-01-01T00:00:00.000Z", "status":null}""")).asJSON
            .check(status.is(201))
