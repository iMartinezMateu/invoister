...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .post("/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "cId":"SAMPLE_TEXT", "mainPhoneNumber":"SAMPLE_TEXT", "secondaryPhoneNumber":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "paypalAccount":"SAMPLE_TEXT", "bankAccount":"SAMPLE_TEXT", "logo":null, "secondaryLogo":null, "stamp":null}""")).asJSON
            .check(status.is(201))
