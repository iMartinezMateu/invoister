...
import { CostumerComponent } from 'app/entities/costumer/costumer.component';
...
describe('Component Tests', () => {
    describe('Costumer Management Component', () => {
        let comp: CostumerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CostumerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.costumers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
