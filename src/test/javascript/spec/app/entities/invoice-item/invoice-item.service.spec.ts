    ...
    describe('InvoiceItem Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/invoice-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a InvoiceItem', () => {
                service.create(new InvoiceItem(null)).subscribe(received => {
            ...
            it('should update a InvoiceItem', () => {
                service.update(new InvoiceItem(123)).subscribe(received => {
            ...
            it('should return a InvoiceItem', () => {
